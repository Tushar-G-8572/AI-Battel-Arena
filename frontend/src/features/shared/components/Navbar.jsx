...
// import { setAiResponse,setProblemStatement, resetAI } from "../../ai/ai.slice";
...
//           <button onClick={handleNewBattle} className="cursor-pointer hover:bg-[#3079d2] hover:text-black px-4 py-2 rounded-md bg-[#004395] flex items-center justify-center text-[#adc6ff] text-xs font-semibold uppercase">New Battle</button>
//         </div>
//             <div className="flex items-center gap-2">
