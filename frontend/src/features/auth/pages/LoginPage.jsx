  ...
  <div className="min-h-screen bg-[#060e20] flex items-center justify-center px-4 py-8 sm:py-12">
    <div className="w-full max-w-xs sm:max-w-sm">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-[#00225a] rounded-xl mb-3 sm:mb-4">
          <svg
            width="20" height="20"
        ...
        <p className="text-[#91aaeb] text-xs sm:text-sm mt-1">Where AI Models Compete</p>
      </div>
      ...
      <div className="bg-[#06122d] rounded-2xl border border-[#2b4680]/30 p-5 sm:p-7">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:gap-4">
          <InputField id="login-email" label="Email" type="email"
